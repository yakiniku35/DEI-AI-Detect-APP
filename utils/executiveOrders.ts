...
export const EXECUTIVE_ORDER_4 = `
...
export const EXECUTIVE_ORDER_METADATA = {
  order1: {
    ...
    date: "2025-01-21",
    description: "Ends illegal preferences; enforces civil-rights laws across agencies and contractors"
  },
  order2: {
    title: "Ending Radical And Wasteful Government DEI Programs And Preferencing", 
    date: "2025-01-20",
    description: "Terminates DEI/DEIA mandates and related programs in Federal Government"
  },
  order3: {
    title: "Defending Women from Gender Ideology Extremism and Restoring Biological Truth",
    date: "2025-01-20", 
    description: "Defines sex-based terms; directs agencies to enforce sex-based distinctions"
  },
  order4: {
    title: "Unleashing American Energy",
    date: "2025-01-20",
    description: "Reorients energy policy toward reliable domestic production and streamlined permitting"
  }
};
